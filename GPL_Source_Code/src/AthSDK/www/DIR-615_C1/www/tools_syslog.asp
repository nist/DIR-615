		...
		<tr>
						...
						<td id="sidenav_container">
							...
							<!-- === BEGIN SIDENAV === -->
								<ul>
									...
									<li><div id="sidenavoff">Syslog</div></li>
			...
			<td valign="top" id="maincontent_container">			  
				<div id="maincontent">
				  ...
				  <div id="box_header"> 
						<h1>SysLog</h1>
						The SysLog options allow you to send log information to a SysLog Server.<br><br>
						<input name="button3" type="button" class=button_submit value="Save Settings" onClick="send_request()">
                        <input name="button2" type=reset class=button_submit value="Don't Save Settings" onclick="page_cancel('form1', 'tools_syslog.asp');">
				  </div>
			 	  <div class="box">
				...
				<table cellpadding="2" cellspacing="0" border="0" bgcolor="#FFFFFF">
                  <tr>
                    <td id="help_text"><strong>Helpful Hints&hellip;</strong>
					  	...
					  	<p><a href="support_tools.asp#SysLog" onclick="return jump_if();">More&hellip;</a></p>
                    </td>
                  </tr>
                </table>
			</td>
