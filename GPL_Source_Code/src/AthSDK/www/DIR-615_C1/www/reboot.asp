           ...
           <table width="650" border="0" align="center">
            <tr>
              <td height="15"><div id=box_header>
                  ...
                  <p class="centered">Please wait <span id="show_sec"></span>&nbsp;seconds.</p>
                  <p>If you changed the IP address of the router you will need to change
                  	the IP address in your browser before accessing the configuration Web site again.
                  </p>
                  <br>
              </div></td>
            </tr>
