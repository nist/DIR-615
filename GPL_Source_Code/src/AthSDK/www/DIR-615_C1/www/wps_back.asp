  ...
  <td bgcolor="#FFFFFF">    <div align="center">
    ...
    <tr>
      <td width="50%"><div id=box_header>
        <h1 align="left">Virtual Push Button</h1>
        <p>&nbsp;</p>
        <p align="center">Please press down the Push Button (physical or virtual) on the wireless <br>device you are adding to your wireless network within <font color="#FF0000"><span id="show_sec"></span></font>&nbsp;seconds &hellip;</p>
  		<p>&nbsp;</p>
      </div>
      </td>
    </tr>
