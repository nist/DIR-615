...
<td bgcolor="#FFFFFF">
  ...
  <table width="650" border="0" align="center">
    <tr>
      <td>
      	<div class=box>
        <h2 align="left">Welcome to the D-Link Setup Wizard</h2>
        <p class="box_msg">This wizard will guide you through a step-by-step process to configure your new D-Link router and connect to the Internet.</p>
                ...
                <table class=formarea>
                    <tr>
                      <td width="334" height="81">
                        <UL>
                          	<LI>Step 1: Set your Password 
                            <LI>Step 2: Select your Time Zone 
                            <LI>Step 3: Configure your Internet Connection 
                ...
                <table align="center" class="formarea">
                  <tr>
                    ...
                    <fieldset id="wz_buttons">
                      <input type="button" class="button_submit" id="wz_prev_b" name="wz_prev_b" value="Prev" disabled>
                      <input type="submit" class="button_submit" id="next_b2" name="next_b2" value="Next" onclick="return send_request()">
                      <input type="button" class="button_submit" id="cancel_b2" name="cancel_b2" value="Cancel" onclick="window.location.href='index.asp'">
