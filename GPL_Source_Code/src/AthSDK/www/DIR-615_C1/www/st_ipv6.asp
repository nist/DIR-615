					...
					<!-- === BEGIN MAINCONTENT === -->
				  	...
				  	<div class="box">
						...
						<table cellpadding="1" cellspacing="1" border="0" width="525">
							<tr>
								<td width="340" align=right class="duple"  nowrap>IPv6 Connection Type :</td>
								<td width="340">&nbsp;
									<span id="connection_ipv6_type" nowrap></span>
								</td>
							</tr>
							<tr id="tr_network_ipv6_status">
								<td align=right class="duple"  nowrap>Network Status :</td>
								<td width="340">&nbsp;
								<span id="network_ipv6_status" nowrap></span>
								</td>
							</tr>
							<tr id="tr_wan_ipv6_addr"x>
								<td align=right class="duple"  nowrap>WAN IPv6 Address :</td>
								<td width="340">&nbsp;
