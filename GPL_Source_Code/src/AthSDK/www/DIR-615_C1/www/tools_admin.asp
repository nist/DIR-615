...
var ori_hostname;
	...
	function onPageLoad()
	{
		...
		if(get_by_id("blank_status").value == 0){
			...
			get_by_id("admin_password1").value = get_by_id("admin_password2").value;
			get_by_id("admPass2").value = get_by_id("admin_password2").value;
		}
		//Display user password
		if(get_by_id("blank_state").value == 0){
			get_by_id("user_password1").value = "";
			get_by_id("usrPass2").value = "";
		}else {
			get_by_id("user_password1").value = get_by_id("user_password2").value;
			get_by_id("usrPass2").value = get_by_id("user_password2").value;
		}
	...
	function send_request(){
    	...
    	var remote_port_msg = replace_msg(check_num_msg, "Remote Admin Port", 1, 65535);
		...
		if (get_by_id("admin_password1").value == ""){
		...
		if(get_by_id("user_password1").value == ""){
			get_by_id("blank_state").value = 0;
		}else{
			get_by_id("user_password1").value = get_by_id("user_password2").value;
			get_by_id("usrPass2").value = get_by_id("user_password2").value;
			get_by_id("blank_state").value = 1;
		}
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
			...
			<form id="form1" name="form1" method="post" action="apply.cgi">
				...
				<input type="hidden" id="blank_state" name="blank_state" value="<% CmoGetCfg("blank_state","none"); %>">		
				...
				<div id="maincontent">	
					...
					<div class="box">
						...
						<table cellpadding="1" cellspacing="1" border="0" width="525">
							<tr>
								<td colspan="2" class="box_msg"><p>Please enter the same password into both boxes, for confirmation.</p></td>
							</tr>
							<tr>
								...
								<td width="340"><font face=Arial size=2>&nbsp;&nbsp;
                                    <input type=password id="admin_password1" name="admin_password1" size=20 maxlength=15 value="" onChange="key_word(this,'admin_password');"></font>
								</td>
							</tr>
							<tr>
								<td class="duple">Verify Password :</td>
								<td width="340"><font face=Arial size=2>&nbsp;&nbsp;
                                    <input type=password id=admPass2 name=admPass2 size=20 maxlength=15 value=""></font>
								</td>
							</tr>														
					  </table>
					</div>
						...
						<table cellpadding="1" cellspacing="1" border="0" width="525">
							...
							<tr>
								<td class="duple">Password :</td>
									...
									<input type="hidden" id="user_password2" name="user_password2" value="WDB8WvbXdH">
								<td width="340"><font face=Arial size=2>&nbsp;&nbsp;
                                    <input type=password id="user_password1" name="user_password1" size=20 maxlength=15 value="" onChange="key_word(this,'user_password');"></font>
								</td>
							</tr>
							<tr>
								<td class="duple">Verify Password :</td>
								<td width="340"><font face=Arial size=2>&nbsp;&nbsp;
                                    <input type="password" id="usrPass2" name="usrPass2" size="20" maxlength="15" value=""></font>
								</td>
							</tr>														
					  </table>
					</div>
					<div class="box">
						...
						<table cellpadding="1" cellspacing="1" border="0" width="525">
							<tr>
								<td class="duple">Gateway Name :</td>
								<td width="340"><font face=Arial size=2>&nbsp;&nbsp;
				  ...
				  <div class="box"> 
				        ...
				        <table cellpadding="1" cellspacing="1" border="0" width="525">
                          ...
                          <tr>
                            <td class="duple">Enable Remote Managment :</td>
                            <td width="340"><div align="left">&nbsp;
                          ...
                          <tr>
                            <td class="duple">Remote Admin Port :</td>
                            <td width="340"><div align="left">&nbsp;&nbsp;
                          ...
                          <tr>
                            <td class="duple">Remote Admin <a href="Inbound_Filter.asp" onClick="return jump_if();">Inbound Filter</a> : </td>
                            <td width="340"><div align="left">&nbsp;&nbsp;
				...
				<table cellpadding="2" cellspacing="0" border="0" bgcolor="#FFFFFF">
					<tr>
					  <td id="help_text">
					  	...
					  	<p>For security reasons, it is recommended that you change the password for the Admin and User accounts. Be sure to write down the new and passwords to avoid having to reset the router in case they are forgotten.</p>
					  	<p>Enabling Remote Management, allows you or others to change the router configuration from a computer on the Internet.</p>
						<p>Choose a port to open for remote management.</p>
						<p>Select a filter that controls access as needed for this admin port. If you do not see the filter you need in the list of filters, go to the <a href="Inbound_Filter.asp" onclick="return jump_if();">Advanced &rarr; Inbound Filter</a> screen and create a new filter.</p>
					  	<p><a href="support_tools.asp#Admin" onclick="return jump_if();">More&hellip;</a></p>
					  </td>
					</tr>
				</table>
			</td>
