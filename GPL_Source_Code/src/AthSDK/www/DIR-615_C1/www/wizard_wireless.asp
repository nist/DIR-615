			...
			<td valign="top" id="maincontent_container">
				<div id=maincontent>				 
				  ...
				  <div class=box>
                    ...
                    If your wireless network is already set up with Wi-Fi Protected Setup, manual confguration of the wireless network will destroy the existing wireless network. If you would like to configure the wireless settings of your new D-Link Corporation Router manually, then click on the Manual Wireless Network Setup button below.<br><br>
