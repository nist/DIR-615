		...
		for (var i = 0; i < rule_max_num; i++){
			...
			if (name.value != ""){
				...
				if(get_by_id("enable" + i).checked == true){
					...
					if(!check_vistual_port(proto_type,get_by_id("public_port" + i).value, "Port")){
					return false;
					}
					if(!check_portforward_port(proto_type,get_by_id("public_port" + i).value, "Port")){
					return false;
					}
			}
                      ...
                      <td id=sidenav_container>
                        <div id=sidenav>                       
                          <UL> 
                            ...
                            <LI><div id=sidenavoff>Application Rules</div></LI>
			...
			<td valign="top" id="maincontent_container">
				<div id=maincontent>			
                  <div id=box_header>
                    ...
                    <input name="button2" type=button class=button_submit value="Don't Save Settings" onclick="page_cancel('form1', 'adv_appl.asp');">
                  </div>
                  <div class=box>
                    <h2><script>document.write(rule_max_num)</script> &ndash;&ndash; APPLICATION RULES</h2>
                    <table borderColor=#ffffff cellSpacing=1 cellPadding=2 width=525 bgColor=#dfdfdf border=1>
                      <tbody>
                        <tr>
                          ...
                          <td align=middle><div align="left"><strong>Port</strong></div></td>
                          <td align=middle><div align="left"><strong>Traffic Type</strong></div></td>
                          <td align=middle><div align="left"><strong>Schedule</strong></div></td>
                        </tr>
						<script>
							...
							document.write("<td rowspan=2 align=center valign=middle>Name<br><input type=text class=flatL id=name" + i + " name=name" + i + " size=15 maxlength=31></td>");
							document.write("<td rowspan=2 align=center valign=middle>Application<br>");
							...
							document.write("<td align=center valign=bottom>Trigger<br><input type=text class=flatL id=trigger_port" + i + " name=trigger_port" + i +" maxLength=31 size=5></td>");
							...
							document.write("<tr>");
							document.write("<td align=center valign=bottom>Firewall<br><input type=text class=flatL id=public_port" + i + " name=public_port" + i +" maxLength=31 size=5></td>");
							document.write("<td align=center valign=middle>");
                  ...
                  <tbody>
                    <tr>
                      <td id=help_text><b>Helpful Hints&hellip;</b>
                      	<p>Use this feature if you are trying to execute one of the listed network applications and it is not communicating as expected.</p>
						...
						<p>Select a schedule for when the service will be enabled. If you do not see the schedule you need in the list of schedules, go to the <a href="tools_schedules.asp" onclick="return jump_if();">Tools &rarr; Schedules</a> screen and create a new schedule.</p>
						<p><a href="support_adv.asp#Special_Applications" onclick="return jump_if();">More&hellip;</a></p>
                      </td>
                    </tr>
                  </tbody>
                </table></td>
