		...
		<tr>
			...
			<!--//OPENDNS-->              
              <div class=box id=show_dhcp>
                ...
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      <td width="185" align=right class="duple">Host Name :</td>
                      <td width="331">&nbsp;
                          <input type=text id="hostname" name="hostname" size="25" maxlength="39" value="<% CmoGetCfg("hostname","none"); %>">
                      </td>
                    </tr>
                    <tr>
                      <td align=right class="duple">DHCP routing option :</td>
                      <td>&nbsp;
                          <input type="checkbox" id="classless_static_route_sel" name="classless_static_route_sel" value="1">
                      </td>
                    </tr>
					<tr>
                      <td align=right class="duple">Use Unicasting :</td>
                      <td>&nbsp;
                          <input type="checkbox" id="dhcpc_use_ucast_sel" name="dhcpc_use_ucast_sel" value="1">(compatibility for some DHCP Servers)
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td align=right valign=top class="duple">MAC Address :</td>
                      <td>&nbsp;
