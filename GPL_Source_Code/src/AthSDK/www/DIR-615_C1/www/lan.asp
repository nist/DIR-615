...
function send_request(){
   ...
   if(wan_proto == "static" && wan_ip_addr != "0.0.0.0"){ // when wan static ip doesn't empty
	...
	if(re.test(lan_device_name)){
		alert("Device name given is invalid");
		return false;
	}
	...
	if (dhcpsvr.checked){
		...
		var less_msg = replace_msg(check_num_msg, "Dhcp Lease Time", 1, 999999);
		...
		if(get_by_id("netbios_announcement").checked && !get_by_id("netbios_learn").checked){
			...
			var wins_ip1_addr_msg = replace_msg(all_ip_addr_msg,"Primary WINS IP Address");
			var wins_ip2_addr_msg = replace_msg(all_ip_addr_msg,"Secondary WINS IP Address");
			...
			for(jj=0;jj<rule_max_num;jj++){
				...
				if(get_by_id("d_mac"+jj).value.length > 0){
					if((get_by_id("d_mac"+jj).value == res_mac) && (jj != i)){
						...
						alert("Reserved IP address for this MAC address '"+ res_mac +"' is already set.");
						check_error = true;
						break;
					}
				}
						...
						<td id="sidenav_container">
							<div id="sidenav">
								<ul>
									...
									<li><div id="sidenavoff">NETWORK SETTINGS</div></li>
			...
			<td valign="top" id="maincontent_container">			  
				<div id="maincontent">
				  <div id="box_header"> 
                        ...
                        <input name="button2" type=reset class=button_submit value="Don't Save Settings" onclick="page_cancel('form1', 'lan.asp');">
		          </div>
				  <div class="box"> 
						<h2>Router Settings</h2>
                            ...
                            <table cellpadding="1" cellspacing="1" border="0" width="525">
								<tr>
									<td class="duple">Router IP Address :</td>
								...
								<tr>
                                  <td class="duple">Local Domain Name :</td>
                                  <td width="340">&nbsp;&nbsp;
								...
								<tr>
									<td class="duple">Enable DNS Relay :</td>
									<td width="340">&nbsp;
				  ...
				  <div class="box"> 
						<h2>DHCP Server Settings</h2>
                          ...
                          <table width="525" border=0 cellPadding=1 cellSpacing=1 class=formarea summary="">
                                <tr>
                                  <td class="duple">Enable DHCP Server :</td>
                                ...
                                <tr>
                                  <td class="duple">DHCP IP Address Range :</td>
                                  <td width="340">&nbsp;
                                ...
                                <tr>
                                  <td class="duple">DHCP Lease Time :</td>
                                  <td width="340">&nbsp;&nbsp;<input type="text" id="dhcpd_lease_time" name="dhcpd_lease_time" size="6" maxlength="6" value="<% CmoGetCfg("dhcpd_lease_time","none"); %>">&nbsp;&nbsp;(minutes)</td>
                                </tr>
                                <tr>
                                  <td class="duple">Always broadcast :</td>
								  <input type="hidden" id="dhcpd_always_bcast" name="dhcpd_always_bcast" value="<% CmoGetCfg("dhcpd_always_bcast","none"); %>">
                                  <td width="340">&nbsp;<input name="always_broadcast" type=checkbox id="always_broadcast" value="1"> (compatibility for some DHCP Clients)</td>
                                </tr>
                                <tr>
                                  <td class="duple">NetBIOS announcement :</td>
                                ...
                                <tr>
                                  <td class="duple">Learn NetBIOS from WAN :</td>
                                ...
                                <tr>
                                  <td class="duple">NetBIOS Scope :</td>
                                  <td width="340">&nbsp;&nbsp;<input type="text" id="dhcpd_static_scope"  name="dhcpd_static_scope" maxlength="30" value="<% CmoGetCfg("dhcpd_static_scope","none"); %>"> (optional)</td>
                                </tr>
                                <tr>
                                  <td class="duple" valign="top">NetBIOS node type :</td>
								  <input type="hidden" id="dhcpd_static_node_type" name="dhcpd_static_node_type" value="<% CmoGetCfg("dhcpd_static_node_type","none"); %>">
                                  <td width="340">
								  &nbsp;<input type="radio" name="netbios_node" value="1">Broadcast only (use when no WINS servers configured)<br>
								  &nbsp;<input type="radio" name="netbios_node" value="2">Point-to-Point (no broadcast)<br>
								  &nbsp;<input type="radio" name="netbios_node" value="4">Mixed-mode (Broadcast then Point-to-Point)<br>
								  &nbsp;<input type="radio" name="netbios_node" value="8">Hybrid (Point-to-Point then Broadcast)
								  </td>
                                </tr>
                                <tr>
                                  <td class="duple">Primary WINS IP Address :</td>
                                  <td width="340">&nbsp;&nbsp;<input type="text" id="wins_ip1"  name="wins_ip1" size="20" maxlength="15"></td>
                                </tr>
                                <tr>
                                  <td class="duple">Secondary WINS IP Address :</td>
				  ...
				  <div class="box" id="add_reserved"> 
						<h2>Add DHCP Reservation</h2>
                          <table width="525" border=0 cellPadding=1 cellSpacing=1 class=formarea summary="">
                                ...
                                <tr>
                                  <td class="duple">Computer Name :</td>
                                  <td width="340">&nbsp;
				  ...
				  <div class=box id="dhcpd_list">
	                  <h2>Number of Dynamic DHCP Clients : <span id="dhcp_num"></span></h2>
	                  <table id="table1" width="525" border=1 cellPadding=1 cellSpacing=1 bgcolor="#DFDFDF" bordercolor="#FFFFFF">
	                      <tr>
				...
				<table cellSpacing=0 cellPadding=2 bgColor=#ffffff border=0>
                    <tr>
                      <td id=help_text><strong>Helpful Hints&hellip;</strong>
                         <p>If you already have a DHCP server on your network or are using static IP addresses on all the devices on your network, uncheck <strong>Enable DHCP Server</strong> to disable this feature.</p>
                         <p>If you have devices on your network that should always have fixed IP addresses, add a <strong>DHCP Reservation</strong> for each such device.</p>
						 <p><a href="support_internet.asp#Network" onclick="return jump_if();">More&hellip;</a></p>
					  </td>
                    </tr>
			  </table></td>
		</tr>
