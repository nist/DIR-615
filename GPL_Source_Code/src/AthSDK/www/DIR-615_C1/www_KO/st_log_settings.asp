...
<script language="JavaScript">	
	...
	function send_request(){
		...
		if(get_by_id("sel_sys_enable").checked){
			var sys_ip_addr_msg = replace_msg(all_ip_addr_msg,which_lang[tsl_SLSIPA];
		...
		<tr>
						...
						<td id="sidenav_container">
							...
							<!-- === BEGIN SIDENAV === -->
								<ul>
									...
									<li><div id="sidenavoff"><script>show_words(which_lang[tsl_SLSt])</script></div></li>
			...
			<td valign="top" id="maincontent_container">			  
				<div id="maincontent">
					<!-- === BEGIN MAINCONTENT === -->
				  <div id="box_header"> 
						<h1><script>show_words(which_lang[_syslog])</script></h1>
						<p><script>show_words(which_lang[tsl_intro])</script></p>
						
            <p> 
              <input name="button3" id="button3" type="button" class=button_submit value="" onClick="send_request()">
              <input name="button2" id="button2" type=reset class=button_submit value="" onclick="page_cancel('form1', 'st_log_settings.asp');">
				 ...
				 <script>get_by_id("button2").value = which_lang[_dontsavesettings];</script>
			 	  ...
			 	  <div class="box">
                    <h2><script>show_words(which_lang[tsl_SLSt])</script></h2>
            		<table cellSpacing=1 cellPadding=2 width=525 border=0>
                      <tr>
                        <td class="duple"><script>show_words(which_lang[tsl_EnLog])</script> :</td>
                      ...
                      <tr id="show_sysip" style="display:none">
                        <td class="duple"><script>show_words(which_lang[tsl_SLSIPA])</script> :</td>
                        <td width=70%> 
          ...
          <p> 
            <script>document.write('<input name="button33" type="button" class=button_submit value="'+which_lang[_savesettings]+'" onClick="send_request()">')</script>
            <script>document.write('<input name="button44" type=reset class=button_submit value="'+which_lang[_dontsavesettings]+'" onclick="window.location.href=st_log_settings.asp">')</script>
          </p>
				</div>
			</td>
			</form>
          ...
          <td id="help_text"><strong><b>
            ...
            <p><script>show_words(which_lang[hhts_def])</script></p>
					  	<p><a href="support_tools.asp#Syslog"><script>show_words(which_lang[_more])</script>&hellip;</a></p>
                    </td>
                  </tr>
                </table>
			</td>
