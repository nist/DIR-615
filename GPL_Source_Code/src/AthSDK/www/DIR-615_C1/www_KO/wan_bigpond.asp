...
function change_wan(){
	...
	function send_bigpond_request(){
		...
		if (ipv6_wan_proto == "ipv6_pppoe"){
			//alert("Please change IPv6 wan protocol at first!");//IPV6_TEXT1
                ...
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="wan_proto" id="wan_proto" onChange="change_wan()">
                        ...
                        <option value="bigpond" selected><script>show_words(which_lang[bwn_Mode_BigPond])</script></option>
                      </select></td>
                    </tr>
                </table>
              </div>
              <div class=box id=show_bigpond>
                <h2><script>show_words(which_lang[bwn_BPICT])</script></h2>
				<p class="box_msg"><script>show_words(which_lang[_ispinfo])</script></p>
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      <td width="185" align=right class="duple"><script>show_words(which_lang[bwn_BPS])</script> :</td>
                      <td width="331">&nbsp;
                      	<input type=text id="wan_bigpond_server" name="wan_bigpond_server" size="20" maxlength="63" value="<% CmoGetCfg("wan_bigpond_server","none"); %>">
                      </td>
                    </tr>
                    <tr>
                      <td align=right class="duple"><script>show_words(which_lang[bwn_BPU])</script> :</td>
                      <td>&nbsp;
                      	<input type=text id="wan_bigpond_username" name="wan_bigpond_username" size="20" maxlength="63" value="<% CmoGetCfg("wan_bigpond_username","none"); %>">
                      </td>
                    </tr>
                    <tr>
                      <td align=right class="duple"><script>show_words(which_lang[bwn_BPP])</script> :</td>
                      <td>&nbsp;
                    ...
                    <tr>
                      <td align=right class="duple"><script>show_words(which_lang[_dns1])</script> :</td>
                      <td>&nbsp;
	                      <input type=text id="wan_primary_dns" name="wan_primary_dns" size="20" maxlength="15" value="<% CmoGetCfg("wan_primary_dns","none"); %>">
                      </td>
                    </tr>
                    <tr>
                      <td align=right class="duple"><script>show_words(which_lang[_dns2])</script> :</td>
                      <td>&nbsp;
                    ...
                    <tr>
                      ...
                      <td>&nbsp;
                      	...
                      	<script>show_words(which_lang[bwn_bytes])</script><script>show_words(which_lang[_308])</script> 1500
                      </td>
                    </tr>
                     <tr>
                      <td width=150 valign=top class="duple"><script>show_words(which_lang[_macaddr])</script> :</td>
                      <td>&nbsp;
