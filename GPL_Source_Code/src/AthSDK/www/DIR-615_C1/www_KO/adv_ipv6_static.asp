		...
		<tr>
		  ...
		  <div id=box_header>
             ...
             <script>show_words(which_lang[IPV6_TEXT28])</script><br>
            		...
            		<input name="button2" id="button2" type="button" class=button_submit value="" onclick="page_cancel_1('form1', 'adv_ipv6_static.asp');">
                   ...
                   <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="ipv6_w_proto" id="ipv6_w_proto" onChange=select_ipv6_wan_page(get_by_id("ipv6_w_proto").value);>
                        <option value="ipv6_static" selected><script>show_words(which_lang[IPV6_TEXT32])</script></option>
	         ...
	         <div class=box id=wan_ipv6_settings>
	                <h2 style=" text-transform:none"><script>show_words(which_lang[IPV6_WAN_IP])</script>  : </h2>
					<p class="box_msg"><script>show_words(which_lang[IPV6_TEXT61])</script> </p>
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>
	                    <tr>
	                      <td width="187" align=right class="duple"><script>show_words(which_lang[IPV6_TEXT0])</script> :</td>
	                      <td width="331">&nbsp;
	                    ...
	                    <tr>
	                      <td align=right class="duple"><script>show_words(which_lang[IPV6_TEXT74])</script> :</td>
	                      <td>&nbsp;
	                    ...
	                    <tr>
	                      <td align=right class="duple"><script>show_words(which_lang[IPV6_TEXT75])</script> :</td>
	                      <td>&nbsp;
	                    ...
	                    <tr>
	                      <td align=right class="duple"><script>show_words(which_lang[wwa_pdns])</script> :</td>
	                      <td>&nbsp;
	                    ...
	                    <tr>
	                      <td align=right class="duple"><script>show_words(which_lang[wwa_sdns])</script> :</td>
	                      <td>&nbsp;
