...
function send_request(){ 
	...
	var remote_ipv4_msg = replace_msg(all_ip_addr_msg,"Remote IPv4 Address");
	...
	var remote_ipv6_msg = replace_msg(all_ipv6_addr_msg,"Remote IPv6 Address");
	...
	var local_ipv4_msg = replace_msg(all_ip_addr_msg,"Local IPv4 Address");
	...
	var local_ipv6_msg = replace_msg(all_ipv6_addr_msg,"Local IPv6 Address");
	...
	var adver_lifetime_obj = new varible_obj(get_by_id("ipv6_6in4_adver_lifetime").value, adver_lifetime_msg , 0, 9999, false);
	...
	/*				if(check_ipv6_symbol(primary_dns,"::")==2){ // find two '::' symbol 
		...
		if(check_mode == 0 && enable_autoconfig == 1){
    		  ...
    		  //set Advertisement Lifetime				 		
					get_by_id("ipv6_ra_adv_default_lifetime_l").value = get_by_id("ipv6_6in4_adver_lifetime").value * 60 ;					 			
...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
		...
		<tr>
		  ...
		  <div id=box_header>
                   ...
                   <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="ipv6_w_proto" id="ipv6_w_proto" onChange=select_ipv6_wan_page(get_by_id("ipv6_w_proto").value);>
                        ...
                        <option value="ipv6_6in4" selected><script>show_words(which_lang[IPV6_TEXT35])</script></option>
                        <option value="ipv6_6to4" ><script>show_words(which_lang[IPV6_TEXT36])</script></option>
						<!--option value="ipv6_stateless" selected><script>show_words(which_lang[TEXT001])</script></option-->
	         ...
	         <div class=box id=wan_ipv6_settings>
	                <h2 style=" text-transform:none"><script>show_words(which_lang[IPV6_TEXT38])</script>  : </h2> 
					<p class="box_msg"><script>show_words(which_lang[IPV6_TEXT39])</script> </p>
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>
						<tr>
							 <td width="187" align=right class="duple"><script>show_words(which_lang[IPV6_TEXT40])</script> :</td>
						...
						<tr>
							<td width="187" align=right class="duple"><script>show_words(which_lang[IPV6_TEXT41])</script> :</td>
						...
						<tr>
							 <td width="187" align=right class="duple"><script>show_words(which_lang[IPV6_TEXT42])</script> :</td>
							 <td width="331">&nbsp;<input type=text id="ipv4_6in4_wan_ip" name="ipv4_6in4_wan_ip" size="16" maxlength="15" value="<% CmoGetCfg("ipv4_6in4_wan_ip","none"); %>"></td>
						</tr>
						<tr>
							<td width="187" align=right class="duple"><script>show_words(which_lang[IPV6_TEXT43])</script> :</td>
 ...
 <p align="justify" class="style1"><script>show_words(which_lang[IPV6_TEXT49])</script></p>
				...
				<tr id="show_ipv6_addr_range_end" style="display:none">
				     <td class="duple"><script>show_words(which_lang[IPV6_TEXT53])</script> :</td>
