...
var DataArray = new Array();
	...
	function del_row(idx){
		...
		if(confirm(which_lang[up_ae_de_1])){
			delete_data(idx);
			send_submit("form1");
		}
	}
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		...
		<input type="hidden" id="firewall_rule_119" name="firewall_rule_119" value="<% CmoGetCfg("firewall_rule_119","none"); %>">
          ...
          <div id=box_header> 
            ...
            <script>show_words(which_lang[aa_intro])</script>
            <br>
            <input name="button" id="button" type="button" class=button_submit value="" onClick="send_request()">
           <input name="button2" id="button2"type="reset" class=button_submit value="" onclick="page_cancel('form1', 'adv_access_control.asp');">
          ...
          <div class=box> 
            <h2> 
              <script>show_words(which_lang[_acccon])</script>
                ...
                <td class="duple"> 
                  <script>show_words(which_lang[aa_EAC])</script>
                  :</td>
					...
					<tr id="show_policy" style="display:none">
						<td class="duple">&nbsp;</td>
						<td width="340">&nbsp;
						<input name="add_policy" id="add_policy" type=button class=button_submit value="" onclick="send_next();">
                		<script>get_by_id("add_policy").value = which_lang[_aa_pol_add];</script>
				</td>
					</tr>
				</table>
			  </div>
            ...
            <h2> 
              <script>show_words(which_lang[aa_Policy_Table])</script>
				...
				<table width="525" id="table1" border=1 cellPadding=1 cellSpacing=1 bgcolor="#DFDFDF" bordercolor="#FFFFFF">
					<tr> 
					  <td width="20"><strong><script>show_words(which_lang[_enable])</script></strong></td> 
					  <td width="80"><strong><script>show_words(which_lang[aa_ACR_c2])</script></strong></td> 
					  <td width="130"><strong><script>show_words(which_lang[aa_Machine])</script></strong></td> 
					  <td width="120"><strong><script>show_words(which_lang[aa_ACR_c5])</script></strong></td> 
					  <td width="50"><strong><script>show_words(which_lang[aa_ACR_c6])</script></strong></td> 
					  <td width="80"><strong><script>show_words(which_lang[_sched])</script></strong></td> 
					  <td>&nbsp;</td>  
					  <td>&nbsp;</td>   
					</tr>
					<script>
          ...
          <td id=help_text><b>
            ...
            &hellip;</b> <p>
              <script>show_words(which_lang[hhac_en])</script>
            </p>
						  
            <p>
              <script>show_words(which_lang[hhac_add])</script>
            </p>
						  
            <p>
              <script>show_words(which_lang[hhac_edit])</script>
            </p>
						  
            <p>
              <script>show_words(which_lang[hhac_delete])</script>
            </p>
						  <p><a href="support_adv.asp#Access_Control" onclick="return jump_if()"><script>show_words(which_lang[_more])</script>&hellip;</a></p>
                      </td>
                    </tr>
                </table>
			</td>
