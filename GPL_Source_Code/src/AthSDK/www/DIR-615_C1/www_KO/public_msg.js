...
//var sequence = new Array("第一", "第二", "第三", "第四", "第五", "第六");
...
var msg = new Array("The IP Address entered is invalid",	//INVALID_IP_ADDRESS
					...
					"SSID 항목은 비워 둘 수 없습니다.",	//SSID_EMPTY_ERROR					
					...
					"끝나는 IP 어드레스는 시작하는 IP 어드레스 보다 커야 함",	//IP_RANGE_ERROR;TEXT039
					...
					"트리거 포트 넘버를 입력하세요",	//TRIGGER_PORT_ERROR ; MSG000
					"방화벽 포트 넘버를 입력하세요",	//PUBLIC_PORT_ERROR
					...
					"사용자 이름을 입력하세요", //PPP_USERNAME_EMPTY;MSG011
...
var all_ip_addr_msg = new Array("%s 는 잘못된 주소입니다.",	// INVALID_IP
						       "%s 는 0이 될 수 없습니다.",	// ZERO_IP
						       "첫번째 주소 %s 반드시 정수여야 합니다.",	// FIRST_IP_ERROR
						       "두번째 주소 %s 반드시 정수여야 합니다.",	// SECOND_IP_ERROR
						       "세번째 주소 %s 반드시 정수여야 합니다.",	// THIRD_IP_ERROR
						       "네번째 주소 %s 반드시 정수여야 합니다.",	// FOURTH_IP_ERROR
						       "%s 의 첫번째 범위는 반드시 사이에 있어야 합니다",			// FIRST_RANGE_ERROR
						       "%s 의 두번째 범위는 반드시 사이에 있어야 합니다",			// SECOND_RANGE_ERROR
						       "%s 의 세번째 범위는 반드시 사이에 있어야 합니다,",			// THIRD_RANGE_ERROR
						       "%s 의 네번째 범위는 반드시 사이에 있어야 합니다",		// FOURTH_RANGE_ERROR
						       "포트 %s 는 잘못 입력되었습니다.",		// RADIUS_SERVER_PORT_ERROR
						       "키값 %s 는 잘못 입력되었습니다",		// RADIUS_SERVER_SECRET_ERROR
						       "%s 는 루프백 IP 또는 멀티캐스트 IP로 허용 할수 없습니다 (127.x.x.x, 224.x.x.x ~ 239.x.x.x)."			// MULTICASE_IP_ERROR
						      );
/*						      
var all_ip_addr_msg = new Array("%s address is invalid.",	// INVALID_IP
						       "%s address is invalid. ",	// ZERO_IP
						       "%s address is invalid. ",	// FIRST_IP_ERROR
						       "%s address is invalid. ",	// SECOND_IP_ERROR
						       "%s address is invalid. ",	// THIRD_IP_ERROR
						       "%s address is invalid. ",	// FOURTH_IP_ERROR
						       "%s address is invalid. ",			// FIRST_RANGE_ERROR
						       "%s address is invalid. ",			// SECOND_RANGE_ERROR
						       "%s address is invalid. ",			// THIRD_RANGE_ERROR
						       "%s address is invalid. ",		// FOURTH_RANGE_ERROR
						       "The %s port entered is invalid.",		// RADIUS_SERVER_PORT_ERROR
						       "The %s secret entered is invalid",		// RADIUS_SERVER_SECRET_ERROR
...
*/
var subnet_mask_msg = new Array("Invalid Netmask.",	// INVALID_IP
					           "Invalid Netmask.",	// ZERO_IP
					           "Invalid Netmask.",	// FIRST_IP_ERROR
					    	   "Invalid Netmask.",	// SECOND_IP_ERROR
					    	   "Invalid Netmask.",	// THIRD_IP_ERROR
					    	   "Invalid Netmask.",	// FOURTH_IP_ERROR
					    	   "Invalid Netmask.",			// FIRST_RANGE_ERROR
					    	   "Invalid Netmask.",			// SECOND_RANGE_ERROR
					    	   "Invalid Netmask.",			// THIRD_RANGE_ERROR
					    	   "Invalid Netmask."			// FOURTH_RANGE_ERROR
					          );					          
...
var check_num_msg = new Array("다른 %s 값을 입력하세요.",
						 "%s의 값은 반드시 숫자여야 합니다!",
						 "%s 의 범위는 %1n ~ %2n 입니다.",
						 "%s 의 값은 반드시 짝수여야 합니다."
						 );
...
var key_len_error = new Array("입력한 키값이 적절하지 않습니다. 키값은 반드시 5 ~ 10 개의 16진수 숫자여야 합니다.",
							  "입력한 키값이 적절하지 않습니다. 키값은 반드시 13 ~ 26 개의 16진수 숫자여야 합니다."
							   );

var illegal_key_error = new Array("키값는 틀림, 유효한 문자는 0~9, A~F, or a~f",
								  "키값는 틀림, 유효한 문자는 0~9, A~F, or a~f",
								  "키값는 틀림, 유효한 문자는 0~9, A~F, or a~f",
								  "키값는 틀림, 유효한 문자는 0~9, A~F, or a~f"								 
								  );
...
var all_ipv6_addr_msg = new Array("%s 는 잘못된 주소입니다.",	// INVALID_IP
						       "%s 는 0이 될 수 없습니다.",	// ZERO_IP such as '::' symbol
						       "첫번째 주소 %s 는 반드시 16진수 여야 합니다.",	// FIRST_IP_ERROR
						       "두번째 주소 %s 는 반드시 16진수 여야 합니다.",	// SECOND_IP_ERROR
						       "세번째 주소 %s 는 반드시 16진수 여야 합니다.",	// THIRD_IP_ERROR
						       "네번째 주소 %s 는 반드시 16진수 여야 합니다.",	// FOURTH_IP_ERROR
						       "다섯번째 주소 %s 는 반드시 16진수 여야 합니다.",	// FIFTH_IP_ERROR
						       "여섯번째 주소 %s 는 반드시 16진수 여야 합니다.",	// SIXTH_IP_ERROR
						       "일곱번째 주소 %s 는 반드시 16진수 여야 합니다.",	// SEVENTH_IP_ERROR
						       "여덟번째 주소 %s 는 반드시 16진수 여야 합니다.",	// EIGHTH_IP_ERROR
						       "%s 의 첫번째 범위는 반드시 사이에 있어야 합니다",		// FIRST_RANGE_ERROR
						       "%s 의 두번째 범위는 반드시 사이에 있어야 합니다",		// SECOND_RANGE_ERROR
						       "%s 의 세번째 범위는 반드시 사이에 있어야 합니다",		// THIRD_RANGE_ERROR
						       "%s 의 네번째 범위는 반드시 사이에 있어야 합니다",		// FOURTH_RANGE_ERROR
						       "%s 의 다섯번째 범위는 반드시 사이에 있어야 합니다",		// FIFTH_RANGE_ERROR
						       "%s 의 여섯번째 범위는 반드시 사이에 있어야 합니다",		// SIXTH_RANGE_ERROR
						       "%s 의 일곱번째 범위는 반드시 사이에 있어야 합니다",		// SEVENTH_RANGE_ERROR
						       "%s 의 여덟번째 범위는 반드시 사이에 있어야 합니다",		// EIGHTH_RANGE_ERROR
						       "", 						// RADIUS_SERVER_PORT_ERROR
						       "",						// RADIUS_SERVER_SECRET_ERROR
  						       "%s 는 루프백 IP로 허용할수 없습니다 ( ::1 ).",  // LOOPBACK_IP_ERROR
  						       "%s 는 멀티캐스트 IP로 허용할수 없습니다 ( FFxx:0:0:0:0:0:0:2 or ffxx:0:0:0:0:0:0:2.  "  // MULTICASE_IP_ERROR	
						      );
