		...
		for(var i = 1; i <= rule_max_num; i++){
			...
			if(enable.checked || name != ""){
				...
				//	alert(" Port Filter name "+ i +" is invalid. The legal characters can not enter ',/,''");
					alert("포트 포워딩 이름 + i + 효력없는. 부적절한 문자 ',/,''");//TEXT007
					return false
				}
...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
          ...
          <div class=box> 
            <h2><script>show_words(which_lang[_aa_wiz_s7_title])</script></h2>
             <P class="box_msg">
              <script>show_words(which_lang[_aa_wiz_s7_msg])</script></P>
            <p><script>show_words(which_lang[_aa_wiz_s7_help])</script></p>
		  ...
		  <td><script>show_words(which_lang[_name])</script></td>
		  <td><script>show_words(which_lang[aa_FPR_c3])</script></td>
		  <td><script>show_words(which_lang[aa_FPR_c4])</script></td>
		  <td><script>show_words(which_lang[_protocol])</script></td>
		  <td><script>show_words(which_lang[aa_FPR_c6])</script></td>
		  <td><script>show_words(which_lang[aa_FPR_c7])</script></td>
					  </tr>
					  <script>
					  	for(var i = 1; i <= rule_max_num; i++){
							document.write("<tr>");
