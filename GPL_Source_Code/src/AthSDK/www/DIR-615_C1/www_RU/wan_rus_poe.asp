...
function send_pppoe_request(){
        ...
        if (dns1 != "" && dns1 != "0.0.0.0"){
			...
			if((get_by_id("wan_pppoe_russia_primary_dns").value =="" || get_by_id("wan_pppoe_russia_primary_dns").value =="0.0.0.0")&& ( get_by_id("wan_pppoe_russia_secondary_dns").value =="" || get_by_id("wan_pppoe_russia_secondary_dns").value =="0.0.0.0")){
...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
			...
			<div id=maincontent>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td  width="331">&nbsp; <select name="wan_proto" id="wan_proto" onChange="change_wan()">
                        ...
                        <option value="pppoe" selected>Russia PPPoE (Dual Access)</option>
              ...
              <div class=box id=show_poe >
                <h2>RUSSIA PPPOE (Dual Access) : </h2>
            ...
            <table cellSpacing=1 cellPadding=1 width=525 border=0>
              <tbody>
                ...
                <tr> 
                  <td class="duple"><div align="right"><font size=2>IP Address 
                      :</font></div></td>
                  <td><font size=2>&nbsp; 
                ...
                <tr> 
                  <td width=185 valign=top class="duple"><div align="right"><font size=2>User 
                      Name :</font></div></td>
                ...
                <tr> 
                  <td width=185 class="duple"><div align="right"><font size=2>Password 
                      :</font></div></td>
                  <td><font size=2>&nbsp; 
                    <input type=password id="poe_pass_s" name="poe_pass_s" size=30 maxlength=63 value="WDB8WvbXdH">
                    </font></td>
                </tr>
                <tr> 
                  <td width=185 class="duple"><div align="right"><font size=2>Verify 
                      Password : </font></div></td>
                  <td><font size=2>&nbsp; 
                    <input type=password id=poe_pass_v name=poe_pass_v size=30 maxlength=63 value="WDB8WvbXdH">
                    </font></td>
                </tr>
                <tr> 
                  <td width=185 class="duple"><div align="right"><font size=2>Service 
                      Name :</font></div></td>
                  <td><font size=2>&nbsp; 
                ...
                <tr> 
                  <td class="duple"><div align="right"><font size=2>Maximum Idle 
                      Time :</font></div></td>
                  <td>&nbsp; <input type=text id="wan_pppoe_max_idle_time_00" name="wan_pppoe_max_idle_time_00" size=5 maxlength=4 value="<% CmoGetCfg("wan_pppoe_max_idle_time_00","none"); %>">
                    					(minutes, 0=infinite)</td>
                </tr>
                <tr> 
                  <td class="duple"><div align="right"><font size=2>MTU :</font></div></td>
                  <td><font size=2>&nbsp; 
                    <input type=text id="wan_pppoe_mtu" name="wan_pppoe_mtu" maxlength=4 size=5 value="<% CmoGetCfg("wan_pppoe_mtu","none"); %>">
                    (bytes) MTU default = 1492 </font></td>
                </tr>
                <tr> 
                  <td width=185 valign=top class="duple"><div align="right"><font size=2> 
        ...
        <div class=box id=show_poe >
                <h2>WAN PHYSICAL SETTING : </h2>
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                  <tbody>
                    <tr>
                      <td  width=185 class="duple"><div align="right">Address Mode</div></td>
                      <td width="331"><font size=2>&nbsp;
                    ...
                    <tr>
                      <td width=150 valign=top class="duple"><div align="right"><font size=2>IP Address :</font></div></td>
                      <td valign=top><font size=2>&nbsp;
                    ...
                    <tr>
                      <td width=150 class="duple"><div align="right"><font size=2>Subnet Mask :</font></div></td>
                      <td><font size=2>&nbsp;
                    ...
                    <tr>
                      <td width=150 class="duple"><div align="right"><font size=2>Gateway : </font></div></td>
                      <td><font size=2>&nbsp;
                    ...
                    <tr>
                      <td width=150 class="duple"><div align="right"><font size=2>Primary DNS Address :</font></div></td>
                      <td>&nbsp;
                    ...
                    <tr>
                      <td width=150 class="duple"><div align="right"><font size=2>Secondary DNS Address :</font></div></td>
                      <td>&nbsp;
