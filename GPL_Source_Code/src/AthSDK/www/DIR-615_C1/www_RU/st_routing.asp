...
<input type="hidden" id="wireless_station_list" name="wireless_station_list" value="<% CmoGetList("wireless_station_list"); %>">
			...
			<td valign="top" id="maincontent_container">
				<div id="maincontent">
					...
					<div id="box_header"> 
						<h1>Routing</h1>
						<b><p>Routing Table</p></b>
						<p>This page displays the routing details configured for your router.</p>
					</div>
					<div class="box"> 
						<h2>Routing table<span id="show_resert"></span></h2>
							<table cellSpacing=1 cellPadding=2 width=525 bgcolor="#FFFFFF">
                              <tr>
							    <TD><b>Deatination IP</b></TD>
							    <TD><b>NetMask</b></TD>
							    <TD><b>Gateway</b></TD>
							    <TD><b>Metric</b></TD>
							    <TD><b>Interface</b></TD>
