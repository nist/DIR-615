...
<script language="JavaScript">
	...
	function set_ipv6_autoconf_range(){
			var ipv6_lan_ip = get_by_id("ipv6_stateless_lan_ip").value;
...
function send_request(){  
	var primary_dns = get_by_id("ipv6_stateless_primary_dns").value;	
	var v6_primary_dns_msg = replace_msg(all_ipv6_addr_msg,"Primary DNS Address");
	var secondary_dns = get_by_id("ipv6_stateless_secondary_dns").value;
	var v6_secondary_dns_msg = replace_msg(all_ipv6_addr_msg,"Secondary DNS Address");
	var ipv6_lan = get_by_id("ipv6_stateless_lan_ip").value;
          ...
          Service Provider.<br>
			...
			<option value="ipv6_stateless" selected>Stateless Autoconfiguration</option>
	         ...
	         <div class=box id=wan_ipv6_settings>
	                <h2 style=" text-transform:none">IPv6 DNS SETTINGS  : </h2>
					<p class="box_msg">Obtain DNS server address automatically or enter a specific DNS server address. </p>
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>	
	                    <tr>
	                      <td width="187" align=right class="duple">Primary DNS Address :</td>
	                      <td width="331">&nbsp;<input type=text id="ipv6_stateless_primary_dns" name="ipv6_stateless_primary_dns" size="30" maxlength="39" value="<% CmoGetCfg("ipv6_stateless_primary_dns","none"); %>"></td>
	                    </tr> 
	                    <tr>
	                      <td width="187" align=right class="duple">Secondary DNS Address :</td>
	                      <td width="331">&nbsp;<input type=text id="ipv6_stateless_secondary_dns" name="ipv6_stateless_secondary_dns" size="30" maxlength="39" value="<% CmoGetCfg("ipv6_stateless_secondary_dns","none"); %>"></td>
	                    </tr>
	                </table>
                 </div>
		 <div class=box id=lan_ipv6_settings>
	                ...
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>
	                    <tr>
	                      ...
	                      <td width="331">&nbsp;
	                      	<input type=text id="ipv6_stateless_lan_ip" name="ipv6_stateless_lan_ip" size="30" maxlength="63" value="<% CmoGetCfg("ipv6_stateless_lan_ip","none"); %>" onChange="set_ipv6_autoconf_range()"> 
	                      	<b>/64</b>
	                      </td>
			    </tr> 
			    <tr> 
