...
var all_ip_addr_msg = new Array("The %s is an invalid address.",	// INVALID_IP
						       ...
						       "The %s can't allow enter loopback IP or multicast IP (127.x.x.x, 224.x.x.x ~ 239.x.x.x)."			// MULTICASE_IP_ERROR
						      );
...
var all_ipv6_addr_msg = new Array("The %s is an invalid address.",	// INVALID_IP
						       "The %s can not be zero.",	// ZERO_IP such as '::' symbol
						       "The 1st address of %s must be a hexadecimal.",	// FIRST_IP_ERROR
						       "The 2nd address of %s must be a hexadecimal.",	// SECOND_IP_ERROR
						       "The 3rd address of %s must be a hexadecimal.",	// THIRD_IP_ERROR
						       "The 4th address of %s must be a hexadecimal.",	// FOURTH_IP_ERROR
						       "The 5th address of %s must be a hexadecimal.",	// FIFTH_IP_ERROR
						       "The 6th address of %s must be a hexadecimal.",	// SIXTH_IP_ERROR
						       "The 7th address of %s must be a hexadecimal.",	// SEVENTH_IP_ERROR
						       "The 8th address of %s must be a hexadecimal.",	// EIGHTH_IP_ERROR
						       "The 1st range of %s must be between ",		// FIRST_RANGE_ERROR
						       "The 2nd range of %s must be between ",		// SECOND_RANGE_ERROR
						       "The 3rd range of %s must be between ",		// THIRD_RANGE_ERROR
						       "The 4th range of %s must be between ",		// FOURTH_RANGE_ERROR
						       ...
						       "",						// RADIUS_SERVER_SECRET_ERROR
  						       "The %s can't allow enter loopback IP ( ::1 ).",  // LOOPBACK_IP_ERROR
  						       "The %s can't allow enter multicast IP ( FFxx:0:0:0:0:0:0:2 or ffxx:0:0:0:0:0:0:2."  // MULTICASE_IP_ERROR	
						      );
