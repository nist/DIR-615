		...
		<tr>
          ...
          Service Provider.<br>
                   ...
                   <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="ipv6_w_proto" id="ipv6_w_proto" onChange=select_ipv6_wan_page(get_by_id("ipv6_w_proto").value);>
                        ...
                        <option value="ipv6_6in4" selected>IPv6 in IPv4 Tunnel</option>
	         ...
	         <div class=box id=wan_ipv6_settings>
	                <h2 style=" text-transform:none">IPv6 in IPv4 TUNNEL SETTINGS  : </h2> 
					<p class="box_msg">Enter the IPv6 in IPv4 Tunnel information provided by your Tunnel Broker. </p>
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>
						<tr>
							 <td width="187" align=right class="duple">Remote IPv4 Address :</td>
						...
						<tr>
							<td width="187" align=right class="duple">Remote IPv6 Address :</td>
						...
						<tr>
							 <td width="187" align=right class="duple">Local IPv4 Address :</td>
						...
						<tr>
							<td width="187" align=right class="duple">Local IPv6 Address :</td>
	                    ...
	                    <tr>
	                      <td width="187" align=right class="duple">Primary DNS Address :</td>
	                    ...
	                    <tr>
	                      <td width="187" align=right class="duple">Secondary DNS Address :</td>
