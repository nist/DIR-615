  ...
  <td bgcolor="#FFFFFF">    <div align="center">
    ...
    <tr>
      <td><div id=box_header>
        ...
        <p>&nbsp;</p>
        <p align="center">You have failed to add the wireless device to your wireless network within the given timeframe, please click on the button below to do it again.</p>
  		<p>&nbsp;</p>
  		<p align="center">
