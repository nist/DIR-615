      ...
      <td height="10">
        ...
        <div align="left">
          ...
          <table width="300" border="0" align="center">
            <tr>
              <td width="123"><strong>User Name&nbsp;:</strong></td>
              <td width="224">
			...
			<table width="300" border="0" align="center" id="show_graph" style="display:none">
              <tr>
                <td height="60" colspan="2"><strong>Enter the correct password above and then type the characters you see in the picture below.</strong>
              ...
              <tr>
                ...
                <td width="262"><input type=button name=Refresh value=Regenerate onClick="window.location.reload( true );" style="width:100 "></td>
                <td>&nbsp;</td>
              </tr>
	        </table>		
			...
			<table width="300" border="0" align="center">
              ...
              <td width="284" align="center"><input type="submit" name="login" id="login" value="Log In" style="width:170 "></td>
