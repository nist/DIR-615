...
var msg = new Array("The IP Address entered is invalid",	//INVALID_IP_ADDRESS
					...
					"SSID 欄位不可以是空白",	//SSID_EMPTY_ERROR					
					...
					"結束IP位址必須大於起始IP位址",	//IP_RANGE_ERROR;TEXT039
					...
					"請輸入一個觸發通訊埠號",	//TRIGGER_PORT_ERROR ; MSG000
					"請輸入一個防火牆通訊埠號",	//PUBLIC_PORT_ERROR
					...
					"請輸入使用者名稱", //PPP_USERNAME_EMPTY;MSG011
...
var all_ip_addr_msg = new Array("%s 為無效的位址。",	// INVALID_IP
						       "%s 內容不能為零。",	// ZERO_IP
						       "第1組位址 %s 必須為一整數。",	// FIRST_IP_ERROR
						       "第2組位址 %s 必須為一整數。",	// SECOND_IP_ERROR
						       "第3組位址 %s 必須為一整數。",	// THIRD_IP_ERROR
						       "第4組位址 %s 必須為一整數。",	// FOURTH_IP_ERROR
						       "第1組位址 %s 必須介於(之間) ",			// FIRST_RANGE_ERROR
						       "第2組位址 %s 必須介於(之間) ",			// SECOND_RANGE_ERROR
						       "第3組位址 %s 必須介於(之間) ",			// THIRD_RANGE_ERROR
						       "第4組位址 %s 必須介於(之間) ",		// FOURTH_RANGE_ERROR
						       "%s 為無效的輸入通訊埠。",		// RADIUS_SERVER_PORT_ERROR
						       "%s 為無效的secret entered。",		// RADIUS_SERVER_SECRET_ERROR
						       "%s 無法允許回送IP 或多點廣播IP (127.x.x.x, 224.x.x.x ~ 239.x.x.x) 規則。"			// MULTICASE_IP_ERROR
						      );
/*						      
...
*/
var subnet_mask_msg = new Array("無效的子網路遮罩。",	// INVALID_IP
					           "無效的子網路遮罩。",	// ZERO_IP
					           "無效的子網路遮罩。",	// FIRST_IP_ERROR
					    	   "無效的子網路遮罩。",	// SECOND_IP_ERROR
					    	   "無效的子網路遮罩。",	// THIRD_IP_ERROR
					    	   "無效的子網路遮罩。",	// FOURTH_IP_ERROR
					    	   "無效的子網路遮罩。",			// FIRST_RANGE_ERROR
					    	   "無效的子網路遮罩。",			// SECOND_RANGE_ERROR
					    	   "無效的子網路遮罩。",			// THIRD_RANGE_ERROR
					    	   "無效的子網路遮罩。"			// FOURTH_RANGE_ERROR
					          );					          
...
var check_num_msg = new Array("請輸入其他的 %s 數值。",
						 "數值內容 %s 必須為數字!",
						 "%s 範圍為 %1n ~ %2n。",
						 "數值內容 %s 必須為一平均數值。"
						 );
...
var key_len_error = new Array("無效的金鑰內容。您所輸入的金鑰內容必須為一個輸入滿5或10個字元的16進位數值",
							  "無效的金鑰內容。您所輸入的金鑰內容必須為一個輸入滿13或26個字元的16進位數值"
							   );

var illegal_key_error = new Array("金鑰是錯誤的，正確的字元應該為0~9、A~F或 a~f。",
								  "金鑰是錯誤的，正確的字元應該為0~9、A~F或 a~f。",
								  "金鑰是錯誤的，正確的字元應該為0~9、A~F或 a~f。",
								  "金鑰是錯誤的，正確的字元應該為0~9、A~F或 a~f。"								 
								  );
...
var all_ipv6_addr_msg = new Array("%s 為無效的位址。",	// INVALID_IP
						       "%s 內容不能為零。",	// ZERO_IP such as '::' symbol
						       "第1組位址 %s 必須為16進位數值。",	// FIRST_IP_ERROR
						       "第2組位址 %s 必須為16進位數值。",	// SECOND_IP_ERROR
						       "第3組位址 %s 必須為16進位數值。",	// THIRD_IP_ERROR
						       "第4組位址 %s 必須為16進位數值。",	// FOURTH_IP_ERROR
						       "第5組位址 %s 必須為16進位數值。",	// FIFTH_IP_ERROR
						       "第6組位址 %s 必須為16進位數值。",	// SIXTH_IP_ERROR
						       "第7組位址 %s 必須為16進位數值。",	// SEVENTH_IP_ERROR
						       "第8組位址 %s 必須為16進位數值。",	// EIGHTH_IP_ERROR
						       "第1組位址 %s 必須介於(之間)  ",		// FIRST_RANGE_ERROR
						       "第2組位址 %s 必須介於(之間)  ",		// SECOND_RANGE_ERROR
						       "第3組位址 %s 必須介於(之間)  ",		// THIRD_RANGE_ERROR
						       "第4組位址 %s 必須介於(之間)  ",		// FOURTH_RANGE_ERROR
						       "第5組位址 %s 必須介於(之間)  ",		// FIFTH_RANGE_ERROR
						       "第6組位址 %s 必須介於(之間)  ",		// SIXTH_RANGE_ERROR
						       "第7組位址 %s 必須介於(之間)  ",		// SEVENTH_RANGE_ERROR
						       "第8組位址 %s 必須介於(之間)  ",		// EIGHTH_RANGE_ERROR
						       "", 						// RADIUS_SERVER_PORT_ERROR
						       "",						// RADIUS_SERVER_SECRET_ERROR
  						       "%s 無法允許記錄至回送IP ( ::1 )。",  // LOOPBACK_IP_ERROR
  						       "%s 無法允許記錄至多點廣播IP ( FFxx:0:0:0:0:0:0:2 or ffxx:0:0:0:0:0:0:2。"  // MULTICASE_IP_ERROR	
						      );
