...
<head><title>D-Link公司 | 无线路由器 | 主页</title>
           ...
           <table width="650" border="0" align="center">
            <tr>
              <td height="15"><div id=box_header>
                  <h1><script>show_words(which_lang[_rs_succeeded])</script></h1>
                  <p><script>show_words(which_lang[rs_intro_4])</script></p>
                  <p><script>show_words(which_lang[ap_intro_noreboot])</script>
                  </p>
                        <p> 
                       		<input name="Button" id="Button" type="button" value="" onClick="back()">
							<script>get_by_id("Button").value = which_lang[ub_continue];</script>
        ...
        <tr id="fail_1" style="display:none">
          <td bgcolor="#FFFFFF"><p>&nbsp;</p>
           <table width="650" border="0" align="center">
            <tr>
              <td height="15"><div id=box_header>
                  <h1><script>show_words(which_lang[_rs_failed])</script></h1>
                  <p><script>show_words(which_lang[rs_intro_1])</script></p>
                  <p>
