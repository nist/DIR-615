						...
						<td id="sidenav_container">
							...
							<!-- === BEGIN SIDENAV === -->
								<ul>
									...
									<li><div id="sidenavoff">DYNAMIC DNS</div></li>
				...
				<div id="maincontent">
				  ...
				  <div id="box_header"> 
						...
						<p>
							...
							a domain name that you have purchased (www.whateveryournameis.com) with your dynamically
							assigned IP address. Most broadband Internet Service Providers assign dynamic (changing)
							IP addresses. Using a DDNS service provider, your friends can enter your host name
							to connect to your game server no matter what your IP address is.</p>
						<p>Sign up for D-Link's Free DDNS service at <a href="http://www.dlinkddns.com" onclick="return jump_if();">www.dlinkddns.com.</a></p>
						<br>
                    	<input name="button1" type="button" class=button_submit value="Save Settings" onClick="send_request();">
                    	<input name="button2" type=reset class=button_submit value="Don't Save Settings" onclick="page_cancel('form1', 'tools_ddns.asp');">
				    <br>           
				  </div>
				  <div class="box"> 
						<h2>DYNAMIC DNS SETTINGS</h2>
							<table width=525 border=0 cellpadding=0>
                             
                                <tr>
                                  <td width=150 align=right class="duple">Enable Dynamic DNS :</td>
                                  <td height=20>&nbsp;
                                ...
                                <tr>
                                  <td align=right class="duple">Server Address :</td>
                                  <td height=20>&nbsp;&nbsp;
                                    ...
                                    <select id="ddns_type_sel" name="ddns_type_sel" tabindex=2>
									  <option>Select Dynamic DNS Server</option>
                                ...
                                <tr>
                                  <td align=right class="duple">Verify Password or Key &nbsp;:</td>
                                  <td height=20>&nbsp;&nbsp;
                                    <input type="password" id="ddns_password2" name="ddns_password2" size="40" maxlength="40" value="WDB8WvbXdH">
                                  </td>
                                </tr>
                                <tr>
                                  <td align=right class="duple">Timeout &nbsp;:</td>
                                  <td height=20>&nbsp;&nbsp;
                                    <input type="text" id="ddns_sync_interval" name="ddns_sync_interval" size="10" maxLength="4" value="<% CmoGetCfg("ddns_sync_interval","none"); %>"> (hours)
                                  </td>
                                </tr>
                                <tr>
                                  <td align=right class="duple">Status &nbsp;:</td>
                                  <td height=20>&nbsp;&nbsp;
                                    <script>
                                    	var ddns_status = "<% CmoGetStatus("ddns_status"); %>";
                                    	var show_ddns_status = "Disconnected";
                                    	if (ddns_status == "success"){
                                    		show_ddns_status = "Connected";
                                    	}
				...
				<table cellpadding="2" cellspacing="0" border="0" bgcolor="#FFFFFF">
					<tr>
					  <td id=help_text><strong>Helpful Hints&hellip;</strong>
					  	<p>To use this feature, you must first have a Dynamic DNS account from one of the providers in the drop down menu.</p>
					  	<p class="more"><a href="support_tools.asp#Dynamic_DNS" onclick="return jump_if();">More&hellip;</a></p>
					  </td>
					</tr>
				</table>
			</td>
