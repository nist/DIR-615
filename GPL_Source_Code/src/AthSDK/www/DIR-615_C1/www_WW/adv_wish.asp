		...
		for (var i = 0; i < rule_max_num; i++){		
			...
			if(get_by_id("name" + i).value != ""){
				...
				temp_obj = 	get_by_id("priority" + i);
   				var priority_msg = replace_msg(check_num_msg, "Priority", 1, 4);
				...
				<div id=maincontent>
                  ...
                  <div class=box>
                    <h2>WISH</h2>
                  	<table width=525>
								  		<tr>
												<td width="185" align=right class="duple">Enable WISH :</td>
                        						<td width="333">&nbsp;
                  ...
                  <div class=box>
                    <h2>Priority Classifiers</h2>
                  	<table width=525>
								  		<tr>
												<td width="185" align=right class="duple">HTTP :</td>
                        <td width="333">&nbsp;
											...
											<tr>
											  <td align=right class="duple">Windows Media Center :</td>
                        <td>&nbsp;
											...
											<tr>
											  <td align=right class="duple">Automatic : </td>
                        <td>&nbsp;
					  						  ...
					  						  (default if not matched by anything else)
					  						</td>
											</tr>
                    </table>
                  </div>
			...
			<td valign="top" width="150" id="sidehelp_container" align="left">
				<table borderColor=#ffffff cellSpacing=0 borderColorDark=#ffffff  cellPadding=2 bgColor=#ffffff borderColorLight=#ffffff border=0>
                  <tr>
	                   ...
	                   <p>Enable this option if you want to allow WISH to prioritize wireless traffic.</p>
	                   <p>For most applications, the priority classifiers ensure the right priorities, and specific WISH Rules are not required.</p>
	                   <p class="more"><a href="support_adv.asp#WISH" onclick="return jump_if();">More&hellip;</a></p>
	                   </TD>
                    </tr>
                </table>
			</td>
