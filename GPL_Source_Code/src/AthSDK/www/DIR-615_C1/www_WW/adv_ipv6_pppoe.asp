		...
		<tr>
                   ...
                   <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="ipv6_w_proto" id="ipv6_w_proto" onChange=select_ipv6_wan_page(get_by_id("ipv6_w_proto").value);>
                        ...
                        <option value="ipv6_pppoe" selected>PPPoE</option>
			...
			<!--option value="ipv6_stateless" selected>Stateless Autoconfiguration</option-->
	         ...
	         <div class=box id=wan_ipv6_settings>
					...
					<!-- p class="box_msg">Obtain DNS server address automatically or enter a specific DNS server address. </p-->
	               	<! p class="box_msg">Enter a specific DNS server address. </p>
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>
		 ...
		 <div class="box" id=ipv6_autoconfiguration_settings> 
			  <h2>ADDRESS AUTOCONFIGURATION SETTINGS</h2>
			   <p class="style1">Use this section to setup IPv6 Autoconfiguration to assign IP addresses to the computers on your network.</p>
