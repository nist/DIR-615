...
<script language="JavaScript">
	...
	function wizard_cancel(){
		...
		if (get_by_id("asp_temp_43").value == "true" && confirm(which_lang[_wizquit])) {
      ...
      <div align="left">
                <div> 
                  <P align="left" class=box_msg>
                    <script>show_words(which_lang[wwa_intro_s4])</script>
                  </P>
          <form id="form1" name="form1" method="post" action="apply.cgi">
            ...
            <table align="center" class=formarea >
                <tr>
                  <td></td>
                  <td>    <input type="button" class="button_submit" id="prev_b" name="prev_b" value="" onclick=window.location="<% CmoGetCfg("html_response_return_page","none"); %>"> 
                          <input type="submit" class="button_submit" id="next_b" name="next_b" value="" disabled> 
