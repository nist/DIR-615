...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
        ...
        <div id=box_header> 
          <h1>
            <script>show_words(which_lang[_internetc])</script>
          </h1>
                  	
          <p>
            <script>show_words(which_lang[int_intro])</script>
          </p>
                  </div>
                  
        <div class=box> 
          <h2>
            <script>show_words(which_lang[int_ConWz])</script>
          </h2>
                    
          <P>
            <script>show_words(which_lang[LW27])</script>
          </P>
          ...
          <script>get_by_id("wizard").value = which_lang[int_ConWz];</script>
		  <p><strong> 
            <script>show_words(which_lang[_note])</script>
            :</strong> 
            <script>show_words(which_lang[bwz_note_ConWz])</script>
          </p>
                  </div>
                  
        <div class=box> 
          <h2>
            <script>show_words(which_lang[LW28])</script>
          </h2>
                    
          <P>
            <script>show_words(which_lang[LW29])</script>
          </P>
                    
          <P class=centered>
            <input name="button2" id="button2" type="button" class=button_submit value="" onclick=window.location.href="sel_wan.asp">
         	<script>get_by_id("button2").value = which_lang[LW30];</script>
		  </p>
                  </div>              
			  </div></td>
          ...
          <td id=help_text><strong> 
            ...
            &hellip;</strong> <p>
              <script>show_words(which_lang[LW33])</script>
            </p>
                          
            <p>
              <script>show_words(which_lang[LW34])</script>
            </p>
