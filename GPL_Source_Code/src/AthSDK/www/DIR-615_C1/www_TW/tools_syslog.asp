...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
						...
						<td id="sidenav_container">
							...
							<!-- === BEGIN SIDENAV === -->
								<ul>
									...
									<li><div id="sidenavoff"><script>show_words(which_lang[_syslog])</script></div></li>
          ...
          <div id="box_header"> 
            <h1>
              <script>show_words(which_lang[_syslog])</script>
            </h1>
            <script>show_words(which_lang[tsl_intro])</script>
            <br>
            <br>
                        <input name="button" id="button" type="submit" class=button_submit value="" onClick="send_request()">
						<input name="button2" id="button2" type=reset class=button_submit value="" onclick="page_cancel('form1', 'tools_syslog.asp');">
          ...
          <div class="box"> 
            <h2> 
              <script>show_words(which_lang[tsl_SLSt])</script>
            </h2>
          ...
          <td id="help_text"><strong> 
            ...
            &hellip;</strong> <p>
              <script>show_words(which_lang[hhts_def])</script>
            </p>
					  	<p><a href="support_tools.asp#SysLog" onclick="return jump_if();"><script>show_words(which_lang[_more])</script>&hellip;</a></p>
                    </td>
                  </tr>
                </table>
			</td>
