...
<script language="JavaScript">
	...
	function click_schedule(){
		...
		if(schedule.value == "-1"){
			...
			if (confirm(which_lang[aa_sched_conf_1]+"\n"+which_lang[aa_sched_conf_2]+"\n"+which_lang[up_ae_wic_3])){
...
<title>D-Link友訊科技(股)有限公司 | 無線寬頻路由器 | Advanced / Access control</title>
</head>
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
          ...
          <div class=box> 
            <h2>
              <script>show_words(which_lang[_aa_wiz_s3_title])</script>
            </h2>
		 	 
            <P class="box_msg">
              <script>show_words(which_lang[_aa_wiz_s3_msg])</script>
            </P>
				  ...
				  <tbody>
					  <tr>
						...
						<select width="30" id="schedule" name="schedule" onChange="click_schedule();">
							<option value="Always" selected><script>show_words(which_lang[_always])</script></option>
							<option value="Never"><script>show_words(which_lang[_never])</script></option>
							<script>
							document.write(set_schedule_option());
							</script>
							<option value="-1"><script>show_words(which_lang[aa_sched_new])</script></option>
						</select>
						</td>
					  </tr>
					  <tr>
