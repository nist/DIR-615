...
<script>
	...
	function send_l2tp_request(){
        ...
        if (fix_ip[1].checked){
            if (!check_lan_setting(temp_ip_obj, temp_mask_obj, temp_gateway_obj, which_lang[_L2TP])){
        		return false;
        	}    
       	}
    	...
    	if(server_ip == ""){
	     ...
	     if (get_by_id("l2tppwd1").value == "" || get_by_id("l2tppwd2").value == ""){
		 	...
		 	alert(which_lang[GW_WAN_L2TP_PASSWORD_INVALID]);
			return false;
		}
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
          ...
          <div id=box_header> 
            ...
            <input name="button" id="button" type="submit" class=button_submit value="" onClick="return send_l2tp_request()">
			...
			<script>get_by_id("button2").value = which_lang[_dontsavesettings];</script>
                ...
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="wan_proto" id="wan_proto" onChange="change_wan()">
                        ...
                        <option value="l2tp" selected><script>show_words(which_lang[bwn_Mode_L2TP])</script></option>
              ...
              <div class=box id=show_l2tp>
                <h2><script>show_words(which_lang[bwn_L2TPICT])</script></h2>
                ...
                <td align=right class="duple">
                  <script>show_words(which_lang[_L2TPip])</script>
                  :</td>
                      <td>&nbsp;
                ...
                <td align=right class="duple">
                  <script>show_words(which_lang[_L2TPsubnet])</script>
                  :</td>
                      <td>&nbsp;
                ...
                <td align=right class="duple">
                  <script>show_words(which_lang[_L2TPgw])</script>
                  :</td>
                      <td>&nbsp;
                ...
                <td align=right class="duple">
                  <script>show_words(which_lang[bwn_L2TPSIPA])</script>
                  :</td>
                      <td>&nbsp;
