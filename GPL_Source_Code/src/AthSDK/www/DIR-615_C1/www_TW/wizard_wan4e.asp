...
var submit_button_flag = 0;
	...
	function send_request(){
        ...
        if(get_by_id("l2tpuserid").value == ""){
    		...
    		alert(which_lang[GW_WAN_L2TP_USERNAME_INVALID]);
    		return false;
	     }
...
<tr>
  <td bgcolor="#FFFFFF"><p>&nbsp;</p>    <table width="650" border="0" align="center">
    <tr>
      <td><div class=box> 
              <h2 align="left">
                <script>show_words(which_lang[wwa_set_l2tp_title])</script>
              </h2>
              <div align="left"> 
                <p class="box_msg">
                  <script>show_words(which_lang[wwa_set_l2tp_msg])</script>
                </p>
          <div>
			...
			<input type="hidden" id="asp_temp_43" name="asp_temp_43" value="<% CmoGetCfg("asp_temp_43","none"); %>">
              <table width="536" align="center" class=formarea>
                ...
                <tr>
                        <td align=right class="duple">
                          <script>show_words(which_lang[wwa_l2tp_svra])</script>
                          &nbsp;:</td>
                  <td>
