...
static struct proc_dir_entry *ar531x_entry = NULL;
...
#define TRICOLOR_LED_GREEN_PIN  15         /* GPIO 15 */
#define TRICOLOR_LED_YELLOW_PIN 3         /* GPIO 4 */
#define OFF 1
#define ON 0
                                        ...
                                        unsigned long count, void *data)
{
    ...
    switch (val) {
        ...
        case LED_STATE_GREEN:
                green_led_onoff = OFF;    /* green ON, Yellow OFF */
                yellow_led_onoff = ON;
                break;

        case LED_STATE_YELLOW:
                green_led_onoff = ON;   /* green OFF, Yellow ON */
                yellow_led_onoff = OFF;
                break;
...
static int create_simple_config_led_proc_entry (void)
{
    ...
    ar531x_entry = proc_mkdir("ar531x", NULL);
    //simple_config_entry = proc_mkdir("simple_config", NULL);
    simple_config_entry = proc_mkdir("gpio", ar531x_entry);
