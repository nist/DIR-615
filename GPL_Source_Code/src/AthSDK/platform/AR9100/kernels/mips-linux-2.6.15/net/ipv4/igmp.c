 ...
 *
 *	Version: $Id: igmp.c,v 1.4 2008/09/10 09:34:52 jimmy_huang Exp $
 *
 *	Authors:
...
//	if (((skb)->nh.iph->daddr & LOCAL_PRIVATE_NETMASK) == LOCAL_PRIVATE_NETMASK){
//		printk("rcv ip = %u:%u:%u:%u - %u:%u:%u:%u \n", NIPQUAD((skb)->nh.iph->saddr) ,NIPQUAD((skb)->nh.iph->daddr));
//		in_dev_put(in_dev);
//		kfree_skb(skb);
//		return 0;		
//	}
