      ...
      struct ipt_entry_target **target)
{
	...
	switch (c) {
		...
		case '2':
			...
			printf("iptables_2_6: nat type: %d\n", info->type);
			return 1;
...
static struct iptables_target nattype = { 
	.name		= "NATTYPE",
