...
static struct iptables_target porttrigger = { 
	.next		= NULL,
	.name		= "PORTTRIGGER",
	.version	= IPTABLES_VERSION,
	.size		= IPT_ALIGN(sizeof(struct ipt_porttrigger_info)),
	.userspacesize	= IPT_ALIGN(sizeof(struct ipt_porttrigger_info)),
	.help		= &help,
	.init		= &init,
	.parse		= &parse,
