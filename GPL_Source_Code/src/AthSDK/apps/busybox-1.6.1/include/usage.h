...
#define dnsmasq_trivial_usage \
       "dns forward"
#define dnsmasq_full_usage \
       "Small and static DNS forward daemon" \
...
#define dumpleases_full_usage \
       ...
       "	-c, --CAMEO type	To follow dnsmasq.lease format"
...
#define httpd_trivial_usage \
	...
	USE_FEATURE_HTTPD_SSL(" [-k certificate file]") \
...
#define httpd_full_usage \
	...
	USE_FEATURE_HTTPD_SSL( \
       "	-k Certificate	Certificate file, including Self-Signed and private key\n" \
       "	-S		Using HTTPS\n") \
