; $Id: snort_installer.nsi,v 1.1 2008/10/01 06:17:23 ken_chiang Exp $
;
; NSIS Installation script for Snort 2.8.2.2 Win32
; Written by Chris Reid <chris.reid@codecraftconsultants.com>
; Updated by Steven Sturges <ssturges@sourcefire.com>
;
; This script will create a Win32 installer for Snort 2.8.2.2 (Win32 only).
...
;Configuration
  ...
  ;General
  OutFile "Snort_2_8_2_2_Installer.exe"  ; The name of the installer executable
