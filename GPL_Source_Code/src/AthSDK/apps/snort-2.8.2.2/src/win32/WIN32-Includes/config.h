/* $Id: config.h,v 1.1 2008/10/01 06:17:23 ken_chiang Exp $ */
 ...
 */
#define VERSION "2.8.2.2"VERSION_ENABLE_ODBC""VERSION_ENABLE_MYSQL""VERSION_ENABLE_MSSQL""VERSION_ENABLE_ORACLE""VERSION_ENABLE_RESPONSE"-WIN32"VERSION_DEBUG
