...
"$Id: plugin.c,v 1.2 2009/03/24 14:33:12 fred Exp $";
...
PPPOEInitDevice(void)
{
    ...
    /* XXX: Big bug!: I can not get pppd_pppoe_service
     * from command line. ( try "pppd xxxx dump" for test).
     * even pppd have passed and find this option, actually ...
     * */
    if (pppd_pppoe_service == NULL)
    	pppd_pppoe_service = getenv("PPPOE_SERVICE");
