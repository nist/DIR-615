...
static CMD_DESCRIPTION_TYPE cmd_options_table[] = 
{
	...
	{"--dyndns_system",	1,	{get_dyndns_system_handler, NULL},	
            ...
            "\t\t-For dyndns.com DNS system: dyndns@dyndns.com OR statdns@dyndns.com OR customdns@dyndns.com.\n"
            ...
            "\t\tDEFAULT value is intended for default service at dyndns.com (most users): dyndns@dyndns.com"},
...
static RC_TYPE get_dyndns_system_handler(CMD_DATA *p_cmd, int current_nr, void *p_context)
{
    ...
    
    {
        ...
        for (; it != NULL && it->id != LAST_DNS_SYSTEM; ++it)
        {
		 ...
		 if (strcmp(it->system.p_key, "default@dyndns.com") == 0)
		{
			default_dns_system = &it->system;
		}
	   }
        }    
    }
    ...
    {
	    if (default_dns_system != NULL) {
		p_self->info.p_dns_system = default_dns_system;
		return RC_OK;
	    } else
        	return RC_DYNDNS_INVALID_OPTION;
    }
