...
public:
	...
	bool show_mrd_version(base_stream &os) const;
	...
	/*! Returns a reference to the logging interface. */
	log_base &log() { return g_rlog; }
...
#define _INTERFACE_CACHE_LEN	32
	...
	friend class snmp_interface_table;
};
