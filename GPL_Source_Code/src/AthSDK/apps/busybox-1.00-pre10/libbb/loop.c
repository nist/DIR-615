...
#ifdef WITH_UCLIBC
/* Need to define bb_kernel_dev_t b/c uClibc doesn't define
 * __kernel_old_dev_t b/c they replace asm/posix_types.h by
 * bits/kernel_types.h */
typedef unsigned int  __bb_kernel_dev_t;
#else
