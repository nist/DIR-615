...
#define DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/home/Noahsark/rootfs/target/usr/local/share/snmp/mibs"
...
#define SNMPLIBPATH "/home/Noahsark/rootfs/target/usr/local/lib/snmp"
#define SNMPSHAREPATH "/home/Noahsark/rootfs/target/usr/local/share/snmp"
#define SNMPCONFPATH "/home/Noahsark/rootfs/target/usr/local/etc/snmp"
#define SNMPDLMODPATH "/home/Noahsark/rootfs/target/usr/local/lib/snmp/dlmod"
...
#define CONFIGURE_OPTIONS "'--enable-mini-agent' '--disable-applications' '--disable-manuals' '--disable-shared' '--with-cflags=-static -O2' '--with-cc=mipsel-uclibc-gcc' '--with-endianness=little' '--build=i386-linux' '--host=mips' '--with-mib-modules=dlink,applicationRuleTable,dlkEnterpriseClientListTable,dlkEnterpriseReservationTable,dlkEnterpriseScanListTable,macFilterTable,portForwardingTable,scheduleRuleTable,virtualServerTable,webFilterTable' '--with-out-mib-modules=snmpv3mibs,mibII/system_mib,mibII/snmp_mib,mibII/sysORTable' '--disable-mib-loading' '--disable-debugging' '--prefix=/home/Noahsark/rootfs/target/usr/local' 'build_alias=i386-linux' 'host_alias=mips'"
