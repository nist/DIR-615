 ...
 */
    ...
    const virtualServerTable_context
        *virtualServerTable_get_by_idx(netsnmp_index *);
    const virtualServerTable_context
        *virtualServerTable_get_by_idx_rs(netsnmp_index *, int row_status);
    int             virtualServerTable_get_value(netsnmp_request_info *,
                                                 netsnmp_index *,
...
#define virtualServerTable_IDX2
    ...
    virtualServerTable_context
        *virtualServerTable_duplicate_row(virtualServerTable_context *);
    netsnmp_index 
        *virtualServerTable_delete_row(virtualServerTable_context *);

    int            
        virtualServerTable_can_delete(virtualServerTable_context *
                                      undo_ctx,
    ...
    virtualServerTable_context *virtualServerTable_get(const char *name,
                                                       int len);
#endif
