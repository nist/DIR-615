 ...
 *
 * $Id: pptp_callmgr.c,v 1.2 2008/02/19 10:35:11 NickChou Exp $
 */
#include <signal.h>
#include <sys/time.h>
#include <sys/types.h>
...
int callmgr_main(int argc, char **argv, char **envp)
{
    ...
    log("callmgr_main: FORK and return status to calling process");        
