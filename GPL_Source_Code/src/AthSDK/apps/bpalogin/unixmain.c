...
/*	Date: 2009-06-01
 *	Name: Cosmo Chang
 *	Reason: For accessing nvram value by new-sutil behavior			
 */ 
...
int main(int argc,char* argv[])
{
	 ...
	 *	Reason: For accessing nvram value by new-sutil behavior			
	 */    
    char *wan_bigpond_auth_value;
    char *wan_bigpond_server_value;
    char *wan_bigpond_username_value;
    char *wan_bigpond_password_value;
	INIT_NVRAM_VALUE(wan_bigpond_auth_value);
	INIT_NVRAM_VALUE(wan_bigpond_server_value);
	INIT_NVRAM_VALUE(wan_bigpond_username_value);
	INIT_NVRAM_VALUE(wan_bigpond_password_value);
	cmd_nvram_get("wan_bigpond_auth",wan_bigpond_auth_value);
	cmd_nvram_get("wan_bigpond_server",wan_bigpond_server_value);
	cmd_nvram_get("wan_bigpond_username",wan_bigpond_username_value);
	cmd_nvram_get("wan_bigpond_password",wan_bigpond_password_value);
...
*/  
	 ...
	 *	Reason: For accessing nvram value by new-sutil behavior			
	 */ 
	strcpy(s.authserver,wan_bigpond_auth_value);    
	strcpy(s.authdomain,wan_bigpond_server_value);    
	strcpy(s.username,wan_bigpond_username_value);    
	strcpy(s.password,wan_bigpond_password_value); 
	FREE_NVRAM_VALUE(wan_bigpond_auth_value);
	FREE_NVRAM_VALUE(wan_bigpond_server_value);
	FREE_NVRAM_VALUE(wan_bigpond_username_value);
	FREE_NVRAM_VALUE(wan_bigpond_password_value);
