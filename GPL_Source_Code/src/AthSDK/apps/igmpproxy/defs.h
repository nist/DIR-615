...
#define     IGMPPROXY_CONFIG_FILEPATH     "/var/etc/igmpproxy.conf"
...
#if 0 //#ifdef RPPPOE
extern struct routeconfig*   routeconf;
...
void log_msg( int Serverity, int Errno, const char *FmtSt, ... );
...
#if 0 //#ifdef RPPPOE 
// russia states
#define DISABLE      			0   // There is no russia enable
#define PHYSICAL_IF      		1   // Interface is the physical interface
#define VIRTUAL_IF    			2   // Interface is the virtual interface
#endif
...
/* jimmy modified 20080402, for cdrouter mcast 51 */
...
#define LOCAL_PRIVATE_NETMASK htonl(0xEF000000L)
