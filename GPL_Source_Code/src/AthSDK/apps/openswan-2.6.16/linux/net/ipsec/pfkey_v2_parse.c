 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parse.c,v 1.1 2008/10/01 02:27:39 ken_chiang Exp $
 */
...
char pfkey_v2_parse_c_version[] = "$Id: pfkey_v2_parse.c,v 1.1 2008/10/01 02:27:39 ken_chiang Exp $";
