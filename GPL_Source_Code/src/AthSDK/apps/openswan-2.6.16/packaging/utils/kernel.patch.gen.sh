#!/bin/bash
#
# RCSID $Id: kernel.patch.gen.sh,v 1.1 2008/10/01 02:35:11 ken_chiang Exp $
...
echo found $i
echo "RCSID \$Id: kernel.patch.gen.sh,v 1.1 2008/10/01 02:35:11 ken_chiang Exp $" >$patchdir/$l
...
# Revision 1.1  2008/10/01 02:35:11  ken_chiang
# *** empty log message ***
#
