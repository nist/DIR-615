 ...
 * for more details.
 *
 * RCSID $Id: pfkey_print.c,v 1.1 2008/10/01 02:24:02 ken_chiang Exp $
 */

char pfkey_v2_print_c_version[] = "$Id: pfkey_print.c,v 1.1 2008/10/01 02:24:02 ken_chiang Exp $";
