 ...
 *
 * $Id: ike-scan.c,v 1.1 2008/10/01 03:43:23 ken_chiang Exp $
 *
...
static const char rcsid[] = "$Id: ike-scan.c,v 1.1 2008/10/01 03:43:23 ken_chiang Exp $";   /* RCS ID for ident(1) */
